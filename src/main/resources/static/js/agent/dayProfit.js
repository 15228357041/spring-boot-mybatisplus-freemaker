    ...
    var dropload = $('.droploadWarp').dropload({
        ...
        loadDownFn: function (me) {
            setTimeout(function () {
                ...
                var result = '';
                $.ajax({
                    url : basePath+'/agProfitRecord/dayProfit.json',
                    ...
                    success : function(data) {
                        if (data.code == 10000) {
                            ...
                            $.each(list,function(i,item){
                                ...
                                var agProfitAmount=typeof(item.agProfitAmount)=="undefined"||item.agProfitAmount==null?"0.00":item.agProfitAmount;
                                ...
                                +' <p class="f12 c85 cyellow">￥'+agProfitAmount.toFixed(2)+'</p>'
                                +'</div>'
                                +'</li>';
                            });
