...
public class MyShiroRealm extends AuthorizingRealm {
  ...
  /*      SimpleAuthenticationInfo authenticationInfo = new SimpleAuthenticationInfo(
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
      ...
      /*  AgUser userInfo  = (AgUser)principals.getPrimaryPrincipal();*/
...
//
//        for(AgentRole role:agent.getRoleList()){
//            authorizationInfo.addRole(role.getCode());
//            List<AgentPermission> plist=role.getPermissionList();
//            for(int i=0;i<plist.size();i++){
//                AgentPermission p=plist.get(i);
//                if(p!=null){
...
//    authorizationInfo.setStringPermissions(getStringPermissions(userInfo.getRoleList()));
     ...
     * @return
     */
//  public Set<String> getStringPermissions(Set<AgentPermission> permissions){
//     Set<String> stringPermissions = new HashSet<String>();
//     if(permissions != null){
//         for(AgentPermission p : permissions) {
