...
public class ScheduleUtils {
    ...
    public static void createScheduleJob(Scheduler scheduler, ScheduleJob scheduleJob) {
        try {
        	//构建job信息
            JobDetail jobDetail = JobBuilder.newJob(ScheduleJobWork.class).withIdentity(getJobKey(scheduleJob.getId())).build();
            ...
            //暂停任务
            if(scheduleJob.getJobStatus() == ScheduleJob.ScheduleStatus.PAUSE.getValue()){
